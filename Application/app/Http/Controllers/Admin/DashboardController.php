...
class DashboardController extends Controller
{
    ...
    {
        $day_array = array();
        $uploads_dates = Image::orderBy('created_at', 'ASC')->pluck('created_at');
    ...
    {
        $daily_upload_count = Image::whereDate('created_at', $day)->get()->count();
    ...
    {
        $day_array = array();
        $users_dates = User::where('permission', 2)->orderBy('created_at', 'ASC')->pluck('created_at');
