      ...
      <form class="card card-md" method="POST" action="{{ route('register') }}">
         ...
         <div class="card-body">
            ...
            <div class="mb-3">
               ...
               <input id="name" type="fullname" class="form-control @error('name') is-invalid @enderror" placeholder="Enter your full name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus onkeypress="return check(event)" maxlength="40">
               @error('name')
