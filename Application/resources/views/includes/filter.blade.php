                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="mb-3 row">
                            ...
                            <div class="col-12">
                                <select class="form-select" data-toggle="drop-category">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3 row">
                            <label class="col-auto col-form-label">Presets</label>
                            <div class="col-12">
                                <select class="form-select" data-toggle="drop-preset" @if(Request::path()=='home' && empty(app('request')->input('c')) ) disabled @endif>
                    ...
                    <div class="col-md-2">
                        <div class="mb-3 row">
                            ...
                            <div class="col-12">
                                <select class="form-select" id="typeGroup" data-toggle="drop-group" @if(Request::path()=='home' && empty(app('request')->input('c')) ) disabled @endif>
                                    {{-- <option  value="">All presets</option> --}}
                                    @php
                    ...
                    <div class="col-md-2">
                        <div class="mb-3 row">
                            ...
                            <div class="col-12">
                                <select class="form-select js-select2" id="tags" data-toggle="drop-tags" @if(Request::path()=='home' && empty(app('request')->input('c')) ) disabled @endif>
                                    @if(count($tags) > 0)
                    ...
                    <div class="col-md-2">
                        <div class="mb-3 row">
                            ...
                            <div class="col-12">
                                <select class="form-select" id="typeImage" data-toggle="drop-type" @if(Request::path()=='home' && empty(app('request')->input('c')) ) disabled @endif>
                                    {{-- <option  value="">All presets</option> --}}
                    ...
                    <div class="col-md-2">
                        <div class="mb-3 row">
                            ...
                            <div class="col-12">
                                <select class="form-select" data-toggle="drop-date" @if(Request::path()=='home' && empty(app('request')->input('c')) ) disabled @endif>
