               ...
               <div class="modal-body">
                  ...
                  <form id="addAdminForm" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control fm40" placeholder="Admin name" name="name" required>
                     </div>
                     <div class="form-group">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td class="text-center">
                     ...
                     <a href="{{ route('edit.user', $user->id) }}" class="btn btn-secondary btn-sm">
