        ...
        <section class="gallery-wrapper-detail py-4 mt-4" data-id="{{ $image->id }}">
            <div class="container-fluid">
                <div class="row d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-2">
                        <button href="" class="btn btn-link float-end">
            ...
            <div class="container-fluid">
                <div class="row align-items-center h-70">
                    <div class="col-auto me-auto">
                        <p class="mb-0">1/100&nbsp;&nbsp;|&nbsp;&nbsp;<b>{{ $image->category }}</b></p>
                    </div>
                    <div class="col-auto">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-link" href="#" data-toggle="tooltip" title="Feedback" data-action="feedback">
                            ...
                            <a class="btn btn-link ms-3" href="{{ route("approvals") }}" data-toggle="tooltip" title="Gallery">
                            ...
                            <a class="btn btn-link ms-3" href="#" data-toggle="tooltip" title="Share">
