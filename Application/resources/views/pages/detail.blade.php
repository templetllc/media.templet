        ...
        <section class="gallery-wrapper-detail py-4 mt-4" data-id="{{ $image->id }}">
            <div class="container-fluid">
                <div class="row d-flex align-items-center justify-content-between mx-0">
                    ...
                    <div class="col-7">
                        <div class="img-item mb-2 text-center">
                ...
                <div class="row align-items-center h-70 mx-0">
                    ...
                    <div class="col-auto">
                        <div class="d-flex align-items-center">
                            <button class="btn btn-link btn-badge" data-top-toggle="tooltip" title="Feedback" data-action="feedback">
                            ...
                            <a class="btn btn-link ms-3" href="{{ route('approvals', array_merge(array($type, $status), ['page' => $page])) }}" data-top-toggle="tooltip" title="Gallery">
                            ...
                            <button class="btn btn-link ms-3" data-top-toggle="tooltip" title="Share" data-action="copyDetailImageUrl">
