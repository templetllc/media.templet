...
@section('content')
<div class="imgbob-drag-zone" id="imgbob-drag-zone" data-category="<?=$category?>" data-preset="<?=$preset?>">
               ...
               <div class="row justify-content-center">
                  <div class="col-10">
                     <div class="imgbob-home-text text-center">
                        ...
                        <p class="imgbob-description d-mobile-none">Drag and drop anywhere you want and start uploading your images now. {{__('Max Filesize. '.$settings->max_filesize.' MB(s)')}} limit. (JPG, PNG, GIF) You can upload up to 1 image at a time.</p>
